<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0" href="https://bloomskin.clinic" target="_blank">
    <img src="{{ asset('img/bloom-skin-clinic-logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
    <span class="ms-1 font-weight-bold">{{ 'Bloom Skin Clinic' }} </span>
  </a>
</div>
...
<div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a href="{{ url('/dashboard') }}" class="nav-link active" aria-expanded="false">
    ...
    {{-- campaing --}}
    <li class="nav-item">
      <a href="{{ route('campaigns.index') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
        ...
        <span class="nav-link-text ms-1">All Campaign</span>
      </a>
    </li>
    @endif
    ...
    <li class="nav-item ">
      ...
      <a data-bs-toggle="collapse" href="#applicationsExamples0" class="nav-link" aria-controls="applicationsExamples0" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>Leads / Appointments</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <div class="collapse" id="applicationsExamples0" style="">
        <ul class="nav ms-4 ps-3">
          {{-- <li class="nav-item ">
          <a class="nav-link " href="javascript:;" id="add-appointment-link">
          <span class="sidenav-mini-icon"> S </span>
          <span class="sidenav-normal">New Lead </span>
          </a>
        </li> --}}
          <li class="nav-item {{ isRouteActive('lead/create') ? 'active' : '' }}">
    ...
    <li class="nav-item ">
      ...
      <a data-bs-toggle="collapse" href="#applicationsExamples1" class="nav-link" aria-controls="applicationsExamples1" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div class="collapse" id="applicationsExamples1" style="">
        <ul class="nav ms-4 ps-3">
          <li class="nav-item {{ isRouteActive('new_appointment') ? 'active' : '' }}">
            <a class="nav-link " href="{{ route('appointment.new_appointment') }}">
              <span class="sidenav-mini-icon"> N </span>
              <span class="sidenav-normal">New Appointment </span>
            </a>
          </li>
          ...
          <li class="nav-item {{ isRouteActive('recurring_appointments') ? 'active' : '' }}">
            <a class="nav-link " href="{{ route('recurring_appoinment') }}">
              <span class="sidenav-mini-icon"> R </span>
              <span class="sidenav-normal"> Recurring </span>
            </a>
          </li>
          <li class="nav-item {{ isRouteActive('assign_appointments') ? 'active' : '' }}">
            <a class="nav-link " href="{{ route('assign_appoinment') }}">
    ...
    <li class="nav-item ">
      ...
      <a href="{{ route('converted_appoinment') }}" class="nav-link">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>Appoinment Converted</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <li class="nav-item ">
      ...
      <div class="collapse" id="applicationsExamples2" style="">
        <ul class="nav ms-4 ps-3">
          <li class="nav-item {{ isRouteActive('expense_type') ? 'active' : '' }}">
            <a class="nav-link " href="{{ route('expense_type.index') }}">
              <span class="sidenav-mini-icon"> A </span>
              <span class="sidenav-normal">Add Expenses Type</span>
            </a>
          </li>
          <li class="nav-item {{ isRouteActive('expense') ? 'active' : '' }}">
    ...
    <li class="nav-item">
      <a href="{{ route('staff.create') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <li class="nav-item">
      <a href="{{ route('staff.index') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <li class="nav-item">
      <a href="{{ route('treatment.create') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <span class="nav-link-text ms-1">Create Treatment</span>
      </a>
    </li>
    <li class="nav-item">
      <a href="{{ route('treatment.index') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>All Staff</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="nav-link-text ms-1">All Treatments</span>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a href="{{ route('patient.all') }}" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
        ...
        <span class="nav-link-text ms-1">Patient Docs</span>
      </a>
    </li>
