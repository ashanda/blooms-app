                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody style="text-align: center;">
                          ...
                          <tr>
                            <td>
                              <h6 class="mb-1 text-dark text-sm me-3">{{ $todayAppoinment->appoinment_id }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm me-3">{{ $todayAppoinment->customer_id }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm">{{ $todayAppoinment->treatment }}</h6>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
                      ...
                      <table class="table">
                        ...
                        <tbody style="text-align: center;">
                          ...
                          <tr>
                            ...
                            <td>
                              <h6 class="mb-1 text-dark text-sm me-3">{{ findSalesAgent($todaysummary->sale_agent_id)->name }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm me-3">{{ $todaysummary->whatsapp_call }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm">{{ $todaysummary->whatsapp_chat }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm">{{ $todaysummary->messenger_chat }}</h6>
                            </td>
                            <td>
                              <h6 class="mb-1 text-dark text-sm">{{ $todaysummary->direct_call }}</h6>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
            ...
            <div class="card text-center">
              <div class="card-body">
                ...
                <div class="appointment-info">
                  ...
                  <p class="card-text" id="appointmentNumber">12345</p>
                  <h5 class="card-title">Patient Name:</h5>
                  <p class="card-text" id="patientName">John Doe</p>
                </div>
                <!-- Doctor Information -->
                <div class="doctor-info mt-3">
                  <h5 class="card-title">Doctor</h5>
                  <p class="card-text" id="doctorName">Dr. Jane Smith</p>
                </div>
              </div>
            </div>
          </div>
